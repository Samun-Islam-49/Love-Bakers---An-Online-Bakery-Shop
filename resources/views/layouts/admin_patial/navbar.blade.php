<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    ...
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"> <a href="{{ route('front.index') }}" class="nav-link">Home</a> </li>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="../../dist/assets/img/user2-160x160.jpg" class="shadow user-image rounded-circle" alt="User Image"> <span class="d-none d-md-inline">{{ Auth::guard('admin')->user()->name }}</span> </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                    <li class="user-header text-bg-primary"> <img src="../../dist/assets/img/user2-160x160.jpg" class="shadow rounded-circle" alt="User Image">
                        <p>
